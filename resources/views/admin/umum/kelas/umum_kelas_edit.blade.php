...
<div class="card card-borderhu border-2 rounded-3">
    ...
    <h2><i><strong>Kelas</strong></i></h2><hr>
                ...
                @if ($errors->any())
                    <div class="alert alert-danger">
                        <div class="alert-title">
                            ...
                            Terdapat kesalahan dalam mengedit data Kelas
                        <ul>
        ...
        <div class="card card-borderhu border-2 rounded-3">
            <div class="card-header  text-light text-center"><h3><i>{{ __('Edit Data Kelas') }}</i></h3></div>

            <div class="card-body">
                <form action="{{ route('update_kelas', $data_kelas) }}" method="post" enctype="multipart/form-data">
                    @method('patch')
                    @csrf
