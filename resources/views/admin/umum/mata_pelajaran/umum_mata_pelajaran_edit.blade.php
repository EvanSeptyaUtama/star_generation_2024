...
<div class="card card-borderhu border-2 rounded-3">
     <div class="card-body">
     <div class="container">
    <h2><i><strong>Mata Pelajaran</strong></i></h2><hr>
        <div class="row">
            <div class="col">
                <!-----Breadcrumbs--->
                ...
                @if ($errors->any())
                    <div class="alert alert-danger">
                        <div class="alert-title">
                            ...
                            Terdapat kesalahan dalam mengedit data Mata Pelajaran
                        <ul>
        ...
        <div class="table-responsive">
            <div class="card">
            <div class="card-header text-light text-center"><h3><i>{{ __('Edit Data Mata Pelajaran') }}</i></h3></div>
                
                <div class="card-body">
                    <form action="{{ route('update_mata_pelajaran', $data_mata_pelajaran) }}" method="post" enctype="multipart/form-data">
                        @method('patch')
                        @csrf
                        <div class="form-group">
                            <label>Mata Pelajaran :</label>
                            <input type="text" name="mata_pelajaran" class="form-control"
                                value="{{ $data_mata_pelajaran->mata_pelajaran }}">
                        </div>
