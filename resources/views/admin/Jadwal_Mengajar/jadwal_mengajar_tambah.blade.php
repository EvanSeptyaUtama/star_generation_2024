                                ...
                                <div class="col">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a
                                                    href="{{ route('index_jadwal_mengajar_guru') }}">Jadwal Mengajar</a>
                                            </li>
                            ...
                            <div class="d-flex justify-content-start mb-2">
                                <div>
                                    <a class="btn btn-outline-warning"
                                        href="{{ route('index_jadwal_mengajar_guru') }}">Kembali</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="table-responsive">
                                <div class="card card-borderhu border-2 rounded-3">
                                    <div class="card-header text-light text-center">
                                        <h3><i>{{ __('Tambah Data Jadwal Mengajar') }}</i></h3>
                                    </div>

                                    <div class="card-body">
                                        <form action="{{ route('store_jadwal_mengajar_guru') }}" method="post"
                                            ...
                                            <div class="row mb-2">
                                                <lable class="col-sm-2 col-label-form">Tenaga Pengajar</lable>
                                                <div class="col-sm-10">
                                                    <select name="tenaga_pengajar_id" class="form-control">
                                                        <option value="">- Pilih Tenaga Pengajar -</option>
                                                        @foreach ($tambah_tenaga_pengajar as $item)
