                    ...
                    <div class="table-responsive">
                        <div class="card card-borderhu border-2 rounded-3">
                            <div class="card-header text-light text-center">
                                <h3><i>{{ __('Edit Biodata Siswa') }}</i></h3>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('update_siswa', $data_siswa) }}" method="post"
                                    ...
                                    <div class="row mb-2">
                                        <label class="col-sm-2 col-label-form">Foto <br> (<i>wajib diisi ulang</i>)</label>
                                        <div class="col-sm-10">
                                            ...
                                            <select name="kelas_id" class="form-control" class="form-control">
                                                @foreach ($edit_kelas as $item)
                                                    <option value="{{ $item->id }}"
                                                        {{ $data_siswa->kelas_id == $item->id ? 'selected' : '' }}>
                                        ...
                                        <div class="col-sm-10">
                                            <select name="jenis_kelamin" class="form-control">
                                                <option value="Laki-Laki"
                                                    {{ $data_siswa->jenis_kelamin === 'Laki-Laki' ? 'Selected' : '' }}>
                                                    Laki-Laki</option>
                                                <option value="Perempuan"
                                                    {{ $data_siswa->jenis_kelamin === 'Perempuan' ? 'Selected' : '' }}>
                                                    Perempuan</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="agama" class="form-control">
                                                <option value="Islam"
                                                    {{ $data_siswa->agama === 'Islam' ? 'Selected' : '' }}>Islam</option>
                                                <option value="Katholik"
                                                    {{ $data_siswa->agama === 'Katholik' ? 'Selected' : '' }}>Katholik
                                                </option>
                                                <option value="Protestan"
                                                    {{ $data_siswa->agama === 'Protestan' ? 'Selected' : '' }}>Protestan
                                                </option>
                                                <option value="Hindu"
                                                    {{ $data_siswa->agama === 'Hindu' ? 'Selected' : '' }}>Hindu</option>
                                                <option value="Budha"
                                                    {{ $data_siswa->agama === 'Budha' ? 'Selected' : '' }}>Budha</option>
                                                <option value="Konghucu"
                                                    {{ $data_siswa->agama === 'Konghucu' ? 'Selected' : '' }}>Konghucu
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-10">
                                            <select name="tinggal_bersama" class="form-control">
                                                <option value="OrangTua"
                                                    {{ $data_siswa->tinggal_bersama === 'OrangTua' ? 'Selected' : '' }}>
                                                    Orang Tua</option>
                                                <option value="Wali"
                                                    {{ $data_siswa->tinggal_bersama === 'Wali' ? 'Selected' : '' }}>Wali
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="desa_kelurahan" class="form-control"
                                                value="{{ $data_siswa->desa_kelurahan }}">
                                        </div>
                                    </div>
                                    <div class="row mb-2">
