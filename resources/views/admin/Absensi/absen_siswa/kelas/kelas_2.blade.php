        ...
        <div class="card card-borderhu border-2 rounded-3">
            <div class="card-body">
                <div class="container-fluid">
                    <h3 class="mt-2"><i><strong>Absensi Siswa</strong></i></h3>
                    <hr>
                    <div class="row">
                        <div class="col">
                            <!-----Breadcrumbs--->
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Laporan Harian Kelas 2</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    <h4><i>Laporan Harian Kelas 2</i></h4>
                    <div class="row justify-content-start mb-1">
                        <div>
                            <a class="btn btn-warning" href="{{ route('index_absen_siswa') }}">Kembali</a>
                            <a class="btn btn-success" href="{{ route('eksport_excel_kelas_2') }}">Export Excel</a>
                        </div>
                    </div>
                    <!----Table---->
                    <div class="row">
