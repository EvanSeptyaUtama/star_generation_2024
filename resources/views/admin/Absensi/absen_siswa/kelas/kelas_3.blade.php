...
@section('title', 'Absensi Siswa | kelas 1')
                        ...
                        <div class="col">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Laporan Harian Kelas 3</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    <h4><i>Laporan Harian Kelas 3</i></h4>
                    <div class="row justify-content-start mb-1">
                        <div>
                            <a class="btn btn-warning" href="{{ route('index_absen_siswa') }}">Kembali</a>
                            <a class="btn btn-success" href="{{ route('eksport_excel_kelas_3') }}">Export Excel</a>
                        </div>
                    </div>
                    <!-----Table--->
                    <div class="row">
