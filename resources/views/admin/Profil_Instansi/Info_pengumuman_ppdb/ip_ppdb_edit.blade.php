                ...
                <div class="container">
                        ...
                        <div class="col-md-12">
                            @if ($errors->any())
                                <div class="alert alert-danger">
                                    ...
                                    Terdapat kesalahan dalam mengedit data Informasi Pengumuman PPDB
                                    <ul>
                    ...
                    <div class="card card-borderhu border-2 rounded-3">
                        <div class="card-header text-light text-center">
                            <h3><i>{{ __('Edit Data Informasi Pengumuman PPDB') }}</i></h3>
                        </div>

                        <div class="card-body m-2">
                            <form action="{{ route('update_ip_ppdb', $data_ip_ppdb) }}" method="post"
                                enctype="multipart/form-data">
                                @method('patch')
                                @csrf
                                <div class="row mb-2">
                                    <label class="col-sm-2 col-label-form">Jalur</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="judul_informasi_pengumuman"class="form-control"
                                            value="{{ $data_ip_ppdb->judul_informasi_pengumuman }}">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="file" name="gambar_informasi_pengumuman"class="form-control"
                                            value="{{ $data_ip_ppdb->gambar_informasi_pengumuman }}">
                                    </div>
                                </div>
