...
@section('title', 'Utama PPDB')
@section('content')
    <div class="m-2">
        <div class="card card-borderhu border-2 rounded-3">
            <div class="card-body">
                <div class="container-fluid">
                    <h2><i><strong>Utama PPDB Profil Instansi</strong></i></h2>
                    <hr>
                    <!-----Breadcrumbs--->
                    <div class="row">
                        <div class="col">
                        ...
                        <div class="col-md-12">
                            @if ($errors->any())
                                <div class="alert alert-danger">
                                    ...
                                    Terdapat kesalahan dalam mengedit data Utama PPDB
                                    <ul>
                    ...
                    <div class="table-responsive">
                        <div class="card card-borderhu border-2 rounded-3">
                            <div class="card-header text-light text-center"><i>
                                    <h3>{{ __('Edit Data Utama PPDB') }}</h3>
                                </i></div>

                            <div class="card-body">
                                <form action="{{ route('update_utama_ppdb', $data_utama_ppdb) }}" method="post"
                                    enctype="multipart/form-data">
                                    @method('patch')
                                    @csrf
                                    <div class="row mb-2">
                                        <label class="col-sm-2 col-label-form">Judul</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="judul_ppdb"class="form-control"
                                                value="{{ $data_utama_ppdb->judul_ppdb }}">
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <label class="col-sm-2 col-label-form">Penjelasan</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="penjelasan_ppdb"class="form-control"
                                                value="{{ $data_utama_ppdb->penjelasan_ppdb }}">
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <label class="col-sm-2 col-label-form">Gambar Brosur PPDB <br> (<i>wajib diisi
                                                ulang</i>)</label>
                                        <div class="col-sm-10">
