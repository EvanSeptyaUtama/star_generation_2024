        ...
        <div class="card card-borderhu border-2 rounded-3">
            <div class="card-body">
                <div class="container-fluid">
                    <h2><i><strong>Halaman Susunan Organisasi Profil Instansi</strong></i></h2>
                    <hr>
                    <!-----Breadcrumbs--->
                    <div class="row">
                        <div class="col">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('index_susunan_organisasi') }}">Halaman
                                            Susunan Organisasi Profil Instansi</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Edit Halaman Susunan Organisasi
                                        Profil Instansi</li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <div class="table-responsive">
                        <div class="card card-borderhu border-2 rounded-3">
                            <div class="card-header text-light text-center"><i>
                                    <h3>{{ __('Edit Data Halaman Susunan Organisasi') }}</h3>
                                </i></div>

                            <div class="card-body">
                                <form action="{{ route('update_susunan_organisasi', $data_susunan_organisasi) }}"
                                    ...
                                    <div class="row mb-2">
                                        <label class="col-sm-2 col-label-form">Foto <br> (<i>wajib diisi
                                                ulang</i>)</label>
                                        <div class="col-sm-10">
                                            <img src="{{ url('storage/Susunan_Organisasi/' . $data_susunan_organisasi->gambar) }}"
                                                class="rounded  mb-1" alt="" width="200px" height="200px">
                                            <input type="file" name="gambar"class="form-control"
                                                value="{{ $data_susunan_organisasi->gambar }}">
                                        </div>
                                    </div>
