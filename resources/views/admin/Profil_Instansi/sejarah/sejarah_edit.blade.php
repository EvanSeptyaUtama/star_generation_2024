                        ...
                        <div class="col">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Edit Halaman Sejarah Profil
                                        Instansi</li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <div class="table-responsive">
                        <div class="card card-borderhu border-2 rounded-3">
                            <div class="card-header text-light text-center"><i>
                                    <h3>{{ __('Edit Data Halaman Sejarah') }}</h3>
                                </i></div>

                            <div class="card-body">
                                <form action="{{ route('update_sejarah', $data_sejarah) }}" method="post"
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="judul_sejarah"class="form-control"
                                                value="{{ $data_sejarah->judul_sejarah }}">
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <label class="col-sm-2 col-label-form">Penejelasan Singkat</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="penjelasan_singkat" class="form-control"
                                                value="{{ $data_sejarah->penjelasan_singkat }}">
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <label class="col-sm-2 col-label-form">Penejelasan Lengkap</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="penjelasan_lengkap" class="form-control"
                                                value="{{ $data_sejarah->penjelasan_lengkap }}">
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input type="file" name="gambar_sejarah"class="form-control"
                                                value="{{ $data_sejarah->gambar_sejarah }}">
                                        </div>
                                    </div>
