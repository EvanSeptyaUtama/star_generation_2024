                        ...
                        <div class="col">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Edit Halaman Aktivitas Profil
                                        Instansi</li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <div class="table-responsive">
                        <div class="card card-borderhu border-2 rounded-3">
                            <div class="card-header  text-light text-center"><i>
                                    <h3>{{ __('Edit Data Halaman Aktivitas') }}</h3>
                                </i></div>

                            <div class="card-body">
                                <form action="{{ route('update_aktivitas', $data_aktivitas) }}" method="post"
                                    enctype="multipart/form-data">
                                    @method('patch')
                                    @csrf
                                    <div class="row mb-2">
                                        <label class="col-sm-2 col-label-form">Aktivitas</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input type="file" name="gambar_aktivitas"class="form-control"
                                                value="{{ $data_aktivitas->gambar_aktivitas }}">
                                        </div>
                                    </div>
